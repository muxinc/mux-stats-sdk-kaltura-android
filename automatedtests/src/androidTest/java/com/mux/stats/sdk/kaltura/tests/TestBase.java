...
import com.mux.stats.sdk.kaltura.tests.ui.SimplePlayerActivity;
...
//    static final int SEEK_PERIOD_IN_MS = 5000;
  ...
  public void init() {
    ...
    testActivity.runOnUiThread(() -> {
      ...
      testActivity.initKalturaPlayer();
...
//    public abstract Bundle getActivityOptions();
  ...
  public void jamNetwork() {
    testActivity.runOnUiThread(() -> {
      ...
      long bufferPosition = testActivity.getPlayer().getBufferedPosition();
